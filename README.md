# ApologistAi Go Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fapologist-project%2Fapg-sdk-go)

The ApologistAi Go library provides convenient access to the ApologistAi APIs from Go.
...
A full reference for this library is available [here](https://github.com/apologist-project/apg-sdk-go/blob/HEAD/./reference.md).
...
```go
response, err := client.Chat.CreateChatCompletion(...)
if err != nil {
...
```go
response, err := client.Chat.WithRawResponse.CreateChatCompletion(...)
if err != nil {
    return err
}
...
response, err := client.Chat.CreateChatCompletion(ctx, ...)
```
...
response, err := client.Chat.CreateChatCompletion(ctx, request, ...)
```
