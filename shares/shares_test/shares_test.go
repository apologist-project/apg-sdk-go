...
func TestSharesGetSharedMessagesWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Shares.GetSharedMessages(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestSharesGetSharedMessagesWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestSharesGetSharedMessagesWithWireMock", "GET", "/shares/token", nil, 1)
}
